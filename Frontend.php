...
<html lang="en">
  <head>
    ...
    <script>
      ...
      })(window, document, "script", "dataLayer", "GTM-P2QFDZ4");
    </script>
...
-->
  ...
  <body>
    ...
    <section class="section" id="products">
      ...
      <div class="container">
        <div class="row">
          <div width="150" height="150" class="col-lg-4">
            <div class="item">
              <div class="thumb">
                <img
                  width="200px"
              ...
              <div class="down-content">
                <h4>
                  <a href="htmcss.html"
                    >Créez votre site web avec HTML5 et CSS</a
                  >
                </h4>
                <span>€ 280.00</span>
              </div>
          ...
          <div width="150" height="150" class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="js.html">Développeur d'application - Javascript</a>
                </h4>
                <span>€ 300.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="Angular.html"
                    >Développeur d'application - Angular JS</a
                  >
                </h4>
                <span>€ 400.00</span>
              </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              <div width="50" height="150" class="thumb">
                <img
                  width="200px"
                  height="200px"
              ...
              <div class="down-content">
                <h4>
                  <a href="Bootstrap.html"
                    >Formation Bootstrap - Créez votre design</a
                  >
                </h4>
                <span>€ 200.00</span>
              </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="Vuejs.html">Apprenez à programmer avec VueJS</a>
                </h4>
                <span>€ 200.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="reactjs.html">Programmez en ReactJs</a>
                </h4>
                <span>€ 500.00</span>
              </div>
            </div>
