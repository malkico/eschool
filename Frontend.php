        ...
        <div class="row">
          ...
          <div width="150" height="150" class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="js.php">Développeur d'application - Javascript</a>
                </h4>
                <span>€ 300.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="Vuejs.php">Apprenez à programmer avec VueJS</a>
                </h4>
                <span>€ 200.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="reactjs.php">Programmez en ReactJs</a>
                </h4>
                <span>€ 500.00</span>
              </div>
            </div>
