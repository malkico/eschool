        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="inner-content">
              <h2>Formations en Backend</h2>
              <span>Java, C#, C++, PHP...</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="nodejs.html">Créez votre site web avec Nodejs</a>
                </h4>
                <span>€ 280.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="cSharp.html">Formation en C#</a>
                </h4>
                <span>€ 480.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="c.html">Apprenez le language C</a>
                </h4>
                <span>€ 200.00</span>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="item">
              ...
              <div class="down-content">
                <h4>
                  <a href="c++.html">Programmez en language C++</a>
                </h4>
                <span>€ 500.00</span>
              </div>
            </div>
