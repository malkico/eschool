...
<body>
    ...
    <section class="section" id="products">
        <div class="detail-tuto">
            ...
            <p>Les choix faits par SolidJS ne sont pas non plus vide de compromis. Le suivi des changements de valeur
                des signaux ne peut se faire que dans un contexte particulier (jsx ou createEffect) et dans certaines
                situation ce suivi ne se fait pas comme on pourrait l'attendre. Cela arrive par exemple si on utilise la
                destructuration.</p>
            <h4>Conclusion</h4>
            <p>Malgré ces inconvénients SolidJS reste une librairie intéréssante pour créer des éléments d'interfaces
                spécifique gràce à un poid léger et des performances optimales avec son approche au plus près du DOM. Il
                faudra tout de même faire attention à sa manière de gérer la réactivité pour voir si elle n'entraine pas
                trop de surprises par rapport aux autres alternatives.</p>
        </div>
