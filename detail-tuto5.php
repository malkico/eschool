...
<head>
    ...
    <meta name="description" content="Jenkins est un outil de gestion de version basé sur le cloud, qui permet d'automatiser des processus de développement. C'est un outil de développement et de gestion des versions" />
...
<body>
    ...
    <section class="section" id="products">
        <div class="detail-tuto">
            <h1>Découverte de Jenkins</h1>
            <p>Jenkins.com est une plate-forme de gestion de développement en ligne. Elle sert à créer des tâches automatisées. Un des avantages de Jenkins est qu'il peut être utilisé pour exécuter des tâches, qui ne sont pas forcément liées au développement en lui-même, comme l'intégration continue ou la surveillance. En outre, il peut gérer différentes configurations d'applications, d'ordinateurs et d'environnements de développement.</p>
           
            <p> Il permet de superviser et d'automatiser des processus de déploiement. Jenkins est conçu pour être utilisé par les développeurs de logiciels, les gestionnaires de contenu et les équipes de production. En utilisant plusieurs plugins, il est possible de faire appel aux aptitudes de Jenkins pour la création de différents outils en ligne : version control, déploiement automatisé, tests unitaires et plus encore.</p>
