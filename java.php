...
<html lang="en">
  <head>
    ...
    />
    <meta name="description" content="Java, programme informatique, par les bases, pratiquant avec des exercices, développer des programme..." />
    ...
    <title>Backend - Créez votre application avec Java</title>
  ...
  <body>
    ...
    <section class="section" id="product">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <div class="left-images">
              ...
              <img src="assets/images/java2.png" alt="" />
            </div>
          </div>
          <div class="col-lg-4">
        ...
        <div>   
          <h4>
                  <a href="php.php">Les participants se sont également intéressés par php</a>
          </h4>
          </div>
      </div>
    </section>
