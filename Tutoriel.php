        ...
        <a href="detail-tuto7.php">
          <div class="col-lg-4 grid-tuto">
            <div class="item">
              <div class="thumb">
                <div class="hover-content"></div>
                <img class="icon-tuto" src="assets/images/Docker-icon.png" alt="" />
              </div>
              <div class="down-content">
                <h4>Decouverte de Docker</h4>
                <span>Dans ce tutoriel je vous propse de découvrir Docker,une
                  theconologie qui permet faire la virtualisation et contenerisation</span>
              </div>
            </div>
          </div>
        </a>
      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="first-item">
            <div class="logo">
              <img width="150px" height="150px" src="assets/images/logo.png" alt="hexashop ecommerce templatemo" />
            </div>
            <ul>
              <li>
