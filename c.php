...
<html lang="en">
  <head>
    ...
    />
    <meta name="description" content="programmation en C, C est un langage, programmation système et la robotique, bases de programmation" />
    ...
    <title>Backend - Créez votre application avec le langage C</title>
  ...
  <body>
    ...
    <section class="section" id="product">
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            <div class="left-images">
              ...
              <img src="assets/images/c2.jfif" alt="" />
            </div>
          </div>
          <div class="col-lg-4">
        ...
        <div>   
          <h4>
                  <a href="c++.php">Les participants se sont également intéressés par C++</a>
          </h4>
          </div>
      </div>
    </section>
